    ...
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table">
        <tr>
          ...
          <td class="cell_content"><input name="AD_Position_Channel_Name" type="text" id="AD_Position_Channel_Name" size="50" maxlength="100" /></td>
        </tr>
        
        <tr>
          <td class="cell_title">频道描述</td>
          <td class="cell_content"><textarea name="AD_Position_Channel_Note" id="AD_Position_Channel_Note" cols="50" rows="5"></textarea></td>
        </tr>
      </table>

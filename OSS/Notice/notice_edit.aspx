...
<script runat="server">
    ...
    private DateTime Notice_Addtime,Notice_ShowTime;
    private string Notice_SEO_Title, Notice_SEO_Keyword, Notice_SEO_Description;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Notice_SEO_Title = entity.Notice_SEO_Title;
            Notice_SEO_Keyword = entity.Notice_SEO_Keyword;
            Notice_SEO_Description = entity.Notice_SEO_Description;
            Notice_ShowTime = entity.Notice_ShowTime;
        }
    }
</script>
                    ...
                    <form id="formadd" name="formadd" method="post" action="notice_do.aspx">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table">
                            ...
                            <tr>
                                ...
                                <td class="cell_content">
                                    <textarea cols="80" id="Notice_Content" name="Notice_Content" rows="16" style="width: 100%"><% =Notice_Content%></textarea>
                            ...
                            <tr>
                                ...
                                <td class="cell_content">
                                    <input type="text" class="input_calendar" name="Notice_ShowTime" id="Notice_ShowTime" maxlength="10" readonly="readonly" value="<%=Notice_ShowTime.ToString("yyyy-MM-dd") %>" />
                                    <script type="text/javascript">
                            ...
                            <tr>
                                ...
                                <td class="cell_content">
                                    <input name="Notice_SEO_Title" type="text" id="Notice_SEO_Title" size="50" maxlength="200" value="<% =Notice_SEO_Title%>" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="cell_content">
                                    <input name="Notice_SEO_Keyword" type="text" id="Notice_SEO_Keyword" size="50" maxlength="200" value="<% =Notice_SEO_Keyword%>" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="cell_content">
                                    <textarea name="Notice_SEO_Description" cols="50" rows="5" id="Notice_SEO_Description"><% =Notice_SEO_Description%></textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="cell_content">
                                    <input name="Notice_IsHot" type="radio" id="Notice_IsHot1" value="1" <% =Public.CheckedRadio(Notice_IsHot.ToString(), "1")%> />是
                                <input type="radio" name="Notice_IsHot" id="Notice_IsHot2" value="0" <% =Public.CheckedRadio(Notice_IsHot.ToString(), "0")%> />否
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="cell_content">
                                    <input name="Notice_IsAudit" type="radio" id="Notice_IsAudit1" value="1" <% =Public.CheckedRadio(Notice_IsAudit.ToString(), "1")%> />是
                                <input type="radio" name="Notice_IsAudit" id="Notice_IsAudit2" value="0" <% =Public.CheckedRadio(Notice_IsAudit.ToString(), "0")%> />否
                                </td>
                            </tr>
                        </table>

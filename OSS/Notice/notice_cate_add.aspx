                ...
                <td class="content_content">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table">
                        ...
                        <tr>
                            ...
                            <td class="cell_content">
                                <input name="Notice_Cate_Sort" type="text" id="Notice_Cate_Sort" value="1" size="10"
                                    maxlength="10" />
                        ...
                        <tr>
                            ...
                            <td class="cell_content">
                                <input name="Notice_Cate_SEO_Title" type="text" id="Notice_Cate_SEO_Title" size="50" maxlength="200" />
                            </td>
                        </tr>
                        <tr>
                            <td class="cell_title">
                            ...
                            <td class="cell_content">
                                <input name="Notice_Cate_SEO_Keyword" type="text" id="Notice_Cate_SEO_Keyword" size="50" maxlength="200" />
                            </td>
                        </tr>
                        <tr>
                            <td class="cell_title">
                            ...
                            <td class="cell_content">
                                <textarea name="Notice_Cate_SEO_Description" cols="50" rows="5" id="Notice_Cate_SEO_Description"></textarea>
                            </td>
                        </tr>
                    </table>

    ...
    <%
        ...
        switch (msgtype)
        {
            case "error":
                ...
                Response.Write(" <a href=\"" + Application["Upload_Server_URL"] + "Public/FileUpload.aspx?App=" + app + "&OrderName=" + Request["OrderName"] + "&formname=" + formname + "&frmelement=" + frmelement + "&rtvalue=" + rtvalue + "&rturl=" + Application["Upload_Server_Return_WWW"] + "\" style=\"color:#5CBDED;\">重新上传</a>");
                break;
            case "success":
                if (rtvalue == "1")
                {
                    switch (app)
                    {
                        ...
                        case "productintro":
                            ...
                            Response.Write("location.href=\"" + Application["Upload_Server_URL"] + "Public/FileUpload.aspx?App=" + app + "&formname=" + formname + "&frmelement=" + frmelement + "&rtvalue=" + rtvalue + "&rturl=" + Application["Upload_Server_Return_WWW"] + "\";</script>");
                            break;
                        case "content":
                            Response.Write("<script type=\"text/javascript\">");
                            ...
                            Response.Write("parent.document." + formname + ".img_" + frmelement + ".value='" + msg + "';");
                            Response.Write("parent.editoradd('<img src=\"" + Application["upload_server_url"] + msg + " \" />','" + frmelement + "');");
                        ...
                        case "video":
                            Response.Write("<script type=\"text/javascript\">");
                            Response.Write("parent.document." + formname + ".img_" + frmelement + ".value='" + msg + "';");
                            Response.Write("parent.editoradd('<video src=\"" + Application["upload_server_url"] + msg + " \" controls=\"controls\" >您的浏览器不支持 video 标签。</video>','" + frmelement + "');");
                            Response.Write("location.href=\"" + Application["Upload_Server_URL"] + "Public/FileUpload.aspx?App=" + app + "&formname=" + formname + "&frmelement=" + frmelement + "&rtvalue=" + rtvalue + "&rturl=" + Application["Upload_Server_Return_WWW"] + "\";</script>");

<%@ Control Language="C#" ClassName="topcate" %>
...
%><div class="logo-head">
    <div class="logo-head-center">
        ...
        <div class="search-right">
           <p>唐山科协欢迎您，<%if(Session["logintype"] == "True") {%><a href="/member/index.aspx"><%=Session["member_nickname"] %></a><a href="/member/login_do.aspx?action=logout" >退出</a><%}else{ %>

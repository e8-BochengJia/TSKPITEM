...
<%
    ...
    if (articlecate != null)
    {
        ...
        {
            Response.Redirect("/online/" + articlecate.Article_Cate_ID + "/");
        }
    }
    else
    {
...
<body style="background: #f5f5f9;">
  ...
  <%--  <p class="crumb-nav">
    ...
    <div class="w-1200 clearfix" style="margin-bottom:30px;">
        ...
        <div class="list-left-kp">
            <%=cms.GetOnline_Top(54,4) %>
            <!-- 2 -->
            <%=cms.GetOnline_Html(55,3,0) %>
            <!-- 3 -->
            <%=cms.GetOnline_Html(56,3,1) %>
        </div>

  
   <!-- 右侧 -->
 <div class="list-right-kp">
      <%=cms.GetOnline_Right(57,11) %>

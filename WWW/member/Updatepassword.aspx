...
<%
    ...
    int memberid = tools.CheckInt(Session["mifno"].ToString());
    if (memberid == 0)
    {
...
<head style="background: #f5f5fa;">
    ...
    <title><%=Application["site_name"].ToString()%>-重置密码</title>
    <meta name="author" content="<%=Application["site_name"].ToString()%>">
    <meta name="Keywords" content="<%=Application["site_name"].ToString()%>-重置密码" />
    <meta name="Description" content="<%=Application["site_name"].ToString()%>-重置密码" />
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#summit_date").click(function () {
                ...
                $.ajax({
                    type: "GET",
                    url: "/member/member_do.aspx?action=findupdatepassword",
...
<body style="background: #f5f5f9;">
    ...
    <!-- 列表 -->
    <p class="crumb-nav">
        <img src="/images/icon-nav.png">当前位置 > <a href="/">首页 </a>>重置密码</p>
        ...
        <div class="news-details">
            <form method="post" name="frm_memeber" id="frm_memeber">
                ...
                <div class="add-product-btn">
                    <a href="javascript:void(0);" id="summit_date" class="add-product-btn-left">重置</a>
